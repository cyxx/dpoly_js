...
b,c,{z:d,ix:e,iy:g,r1:k,r2:h,r3:f})},setDefaultPalette:function(){for(var a=0;16>a;a++){var b="#"+a.toString(16)+a.toString(16)+a.toString(16);this.m_palette[16+a]=this.m_palette[a]=b}this.m_fixUpPalette=0},setTaxiPalette:function(){for(var a="000 fff 000 886 664 444 aa8 684 ec0 ea0 c60 a40 620 66c 44a e86".split(" "),b=0;16>b;++b)this.m_palette[16+b]="#"+a[b];this.m_fixUpPalette=1},setPalette:function(a,b){var c=this.readWord(this.m_pol,6),c=c+32*a,d=0;if(0==b){if(0!=this.m_fixUpPalette)return;d=
16}for(var e=0;16>e;e++){var g=this.readWord(this.m_pol,c),c=c+2,k=g>>4&15,h=g&15;this.m_palette[d]="#"+(g>>8&15).toString(16)+k.toString(16)+h.toString(16);++d}},flipScreen:function(){0!=this.m_clear?this.clearPrimitives():this.restorePrimitives()},queuePrimitive:function(a,b,c,d,e,g,k,h){this.m_primitives.push({x:a,y:b,dx:c,dy:d,num:e,color:g,alpha:k,transform:h})},clearPrimitives:function(){this.m_primitives=[]},restorePrimitives:function(){this.m_primitives=this.m_savedPrimitives.slice()},savePrimitives:function(){this.m_savedPrimitives=
this.m_primitives.slice()},drawPrimitive:function(a,b,c,d,e,g,k,h){var f=this.readWord(this.m_pol,10);g=this.readWord(this.m_pol,f+2*g);f=this.readWord(this.m_pol,18);f+=g;g=this.readByte(this.m_pol,f);f++;var l=this.m_scale;a.fillStyle=a.strokeStyle=this.m_palette[k];a.save();a.scale(l,l);k=this.toSignedWord(this.readWord(this.m_pol,f));var f=f+2,m=this.toSignedWord(this.readWord(this.m_pol,f)),f=f+2;h&&(a.translate(h.ix,h.iy),a.scale(h.z/512,h.z/512),k-=h.ix,m-=h.iy);b+=k+d;c+=m+e;if(g&128)a.translate(b,
c),b=this.toSignedWord(this.readWord(this.m_pol,f)),f=this.toSignedWord(this.readWord(this.m_pol,f+2)),a.scale(b,f),a.beginPath(),a.arc(0,0,1,0,2*Math.PI,!1),a.closePath(),a.fill();else if(0==g)a.fillRect(b,c,l,l);else{a.beginPath();a.moveTo(b,c);for(h=0;h<g;++h)d=this.toSignedByte(this.readByte(this.m_pol,f)),f++,e=this.toSignedByte(this.readByte(this.m_pol,f)),f++,b+=d,c+=e,a.lineTo(b,c);a.closePath();2>g?a.stroke():a.fill()}a.restore()},readUint16BE:function(a,b){var c=256*a.charCodeAt(b);return c+=
a.charCodeAt(b+1)},readUint32BE:function(a,b){var c=this.readUint16BE(a,b)<<16;return c|=this.readUint16BE(a,b+2)},decode:function(a,b){var c=0,d=this.readUint32BE(a,c),c=c+4;console.log("POL size="+d);if(d&-2147483648)d=4294967296-d,this.m_pol=a.slice(c,c+d);else{this.readUint32BE(a,c+d-4);var e=a.slice(c,c+d);decoder.decode(e);this.m_pol=decoder.m_out}c+=d;d=this.readUint32BE(a,c);c+=4;console.log("CMD size="+d);d&-2147483648?this.m_cmd=a.slice(c,c+(4294967296-d)):(this.readUint32BE(a,c+d-4),c=
a.slice(c,c+d),decoder.decode(c),this.m_cmd=decoder.m_out)}},player_set={m_pos:0,m_playing:!1,m_scale:2,m_backgroundShapeOffsets:null,m_foregroundShapeOffsets:null,m_palette:Array(16),init:function(a){this.m_canvas=document.getElementById(a)},start:function(a){this.m_pos=10;a=this.readWord(this.m_set,this.m_pos);this.m_pos+=2;console.log("frames="+a);this.m_playing=!0;this.m_timer=setInterval(function(){player_set.doTick()},100)},stop:function(){this.m_playing=!1;this.m_timer&&(clearInterval(this.m_timer),
this.m_timer=null)},toSignedWord:function(a){return a-((a&32768)<<1)},doTick:function(){this.m_playing&&this.drawNextFrame()},readPalette:function(a){a+=12;for(var b=0;16>b;b++){var c=this.readWord(this.m_set,a);a+=2;var d=c>>4&15,e=c&15;this.m_palette[b]="#"+(c>>8&15).toString(16)+d.toString(16)+e.toString(16)}},drawShape:function(a,b,c,d){this.readPalette(b.offset+b.size);b=b.offset;var e=this.readWord(this.m_set,b);b+=2;for(var g=0;g<e-1;++g){b+=5;var k=this.readByte(this.m_set,b);++b;var h=this.toSignedWord(this.readWord(this.m_set,
b));b+=2;var f=this.toSignedWord(this.readWord(this.m_set,b));b+=2;var l=this.readByte(this.m_set,b);++b;this.readByte(this.m_set,b);++b;a.save();a.fillStyle=a.strokeStyle=this.m_palette[l];if(255==k){k=this.toSignedWord(this.readWord(this.m_set,b));b+=2;l=this.toSignedWord(this.readWord(this.m_set,b));b+=2;if(0>k||0>l)continue;a.translate(h+c,f+d);a.scale(k,l);a.beginPath();a.arc(0,0,1,0,2*Math.PI,!1);a.closePath();a.fill()}else{a.beginPath();for(h=0;h<k;++h)f=this.toSignedWord(this.readWord(this.m_set,
b)),b+=2,l=this.toSignedWord(this.readWord(this.m_set,b)),b+=2,0==h?a.moveTo(f+c,l+d):a.lineTo(f+c,l+d);a.closePath();2>k?a.stroke():a.fill()}a.restore()}},drawNextFrame:function(){var a=this.m_canvas.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,this.m_canvas.width,this.m_canvas.height);var b=this.readWord(this.m_set,this.m_pos);this.m_pos+=2;var c=this.readWord(this.m_set,this.m_pos);this.m_pos+=2;if(0==c)this.m_playing=!1;else{a.save();a.scale(this.m_scale,this.m_scale);this.drawShape(a,this.m_backgroundShapeOffsets[b],
0,0);for(var d=0;d<c;++d){b=this.readWord(this.m_set,this.m_pos);this.m_pos+=2;var e=this.toSignedWord(this.readWord(this.m_set,this.m_pos));this.m_pos+=2;var g=this.toSignedWord(this.readWord(this.m_set,this.m_pos));this.m_pos+=2;this.drawShape(a,this.m_foregroundShapeOffsets[b],e,g)}a.restore()}},readByte:function(a,b){return a.charCodeAt(b)},readWord:function(a,b){var c=256*a.charCodeAt(b);return c+=a.charCodeAt(b+1)},readShapeOffset:function(a,b){var c=this.readWord(a,b);b+=2;for(var d=0;d<c-
1;++d){b+=5;var e=this.readByte(a,b);++b;b+=6;b=255==e?b+4:b+4*e}return b},decode:function(a,b){this.m_backgroundShapeOffsets=[];var c=this.readWord(a,b);b+=2;console.log("SET bg="+c);for(var d=0;d<c;++d){var e=this.readShapeOffset(a,b);this.m_backgroundShapeOffsets.push({offset:b,size:e-b});b=e+45}this.m_foregroundShapeOffsets=[];c=this.readWord(a,b);b+=2;console.log("SET fg="+c);for(d=0;d<c;++d)e=this.readShapeOffset(a,b),this.m_foregroundShapeOffsets.push({offset:b,size:e-b}),b=e+45;this.m_set=
a}};
