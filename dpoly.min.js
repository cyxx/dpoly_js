...
var d=this.readNextByte(),g=this.readNextByte(),f=this.readNextWord(),h=90;a&8192&&(a&=8191,h=this.readNextWord());var k=180;a&4096&&(a&=4095,k=this.readNextWord());this.drawShapeScaleRotate(a,b,c,e,d,g,f,h,k);break;case 12:this.m_yield=10;break;case 13:a=this.readNextWord();65535!=a&&(this.readNextByte(),this.readNextByte());break;default:console.log("Invalid opcode="+a),this.m_playing=!1}}},updateScreen:function(){var a=this.m_canvas.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,this.m_canvas.width,
this.m_canvas.height);for(a=0;a<this.m_primitives.length;a++){var b=this.m_primitives[a];this.drawPrimitive(b.x,b.y,b.dx,b.dy,b.num,b.color,!1,b.transform)}this.flipScreen();this.m_yield=5},clearScreen:function(){0!=this.m_clear&&this.flipScreen()},drawShape:function(a,b,c,e){var d=this.readWord(this.m_pol,2);a=this.readWord(this.m_pol,d+2*a);d=this.readWord(this.m_pol,14);d+=a;a=this.readWord(this.m_pol,d);for(var d=d+2,g,f,h=0;h<a;++h){var k=this.readWord(this.m_pol,d),d=d+2;k&32768?(g=this.toSignedWord(this.readWord(this.m_pol,
d)),d+=2,f=this.toSignedWord(this.readWord(this.m_pol,d)),d+=2):f=g=0;var m=0!=(k&16384),l=this.readByte(this.m_pol,d);d++;0==this.m_clear&&(l+=16);this.queuePrimitive(b,c,g,f,k&16383,l,m,e)}0!=this.m_clear&&this.savePrimitives()},drawShapeScale:function(a,b,c,e,d,g){this.drawShape(a,b,c,{z:e,ix:d,iy:g})},drawShapeScaleRotate:function(a,b,c,e,d,g,f,h,k){this.drawShape(a,b,c,{z:e,ix:d,iy:g,r1:f,r2:h,r3:k})},setDefaultPalette:function(){for(var a=0;16>a;a++){var b="#"+a.toString(16)+a.toString(16)+
a.toString(16);this.m_palette[16+a]=this.m_palette[a]=b}this.m_fixUpPalette=0},setTaxiPalette:function(){for(var a="000 fff 000 886 664 444 aa8 684 ec0 ea0 c60 a40 620 66c 44a e86".split(" "),b=0;16>b;++b)this.m_palette[16+b]="#"+a[b];this.m_fixUpPalette=1},setPalette:function(a,b){var c=this.readWord(this.m_pol,6),c=c+32*a,e=0;if(0==b){if(0!=this.m_fixUpPalette)return;e=16}for(var d=0;16>d;d++){var g=this.readWord(this.m_pol,c),c=c+2,f=g>>4&15,h=g&15;this.m_palette[e]="#"+(g>>8&15).toString(16)+
f.toString(16)+h.toString(16);++e}},flipScreen:function(){0!=this.m_clear?this.clearPrimitives():this.restorePrimitives()},queuePrimitive:function(a,b,c,e,d,g,f,h){this.m_primitives.push({x:a,y:b,dx:c,dy:e,num:d,color:g,transform:h})},clearPrimitives:function(){this.m_primitives=[]},restorePrimitives:function(){this.m_primitives=this.m_savedPrimitives.slice()},savePrimitives:function(){this.m_savedPrimitives=this.m_primitives.slice()},drawPrimitive:function(a,b,c,e,d,g,f,h){f=this.readWord(this.m_pol,
10);d=this.readWord(this.m_pol,f+2*d);f=this.readWord(this.m_pol,18);f+=d;var k=this.readByte(this.m_pol,f);f++;var m=this.m_scale;d=this.m_canvas.getContext("2d");d.fillStyle=d.strokeStyle=this.m_palette[g];d.save();d.scale(m,m);g=this.toSignedWord(this.readWord(this.m_pol,f));f+=2;var l=this.toSignedWord(this.readWord(this.m_pol,f));f+=2;h&&(d.translate(h.ix,h.iy),d.scale(h.z/512,h.z/512),g-=h.ix,l-=h.iy);a+=g+c;b+=l+e;if(k&128)d.translate(a,b),a=this.toSignedWord(this.readWord(this.m_pol,f)),b=
this.toSignedWord(this.readWord(this.m_pol,f+2)),d.scale(a,b),d.beginPath(),d.arc(0,0,1,0,2*Math.PI,!1),d.closePath(),d.fill();else if(0==k)d.fillRect(a,b,m,m);else{d.beginPath();d.moveTo(a,b);for(h=0;h<k;++h)c=this.toSignedByte(this.readByte(this.m_pol,f)),f++,e=this.toSignedByte(this.readByte(this.m_pol,f)),f++,a+=c,b+=e,d.lineTo(a,b);d.closePath();2>k?d.stroke():d.fill()}d.restore()},readUint16BE:function(a,b){var c=256*a.charCodeAt(b);return c+=a.charCodeAt(b+1)},readUint32BE:function(a,b){var c=
this.readUint16BE(a,b)<<16;return c|=this.readUint16BE(a,b+2)},decode:function(a){var b=0,c=this.readUint32BE(a,b),b=b+4;console.log("POL size="+c);if(c&-2147483648)c=4294967296-c,this.m_pol=a.slice(b,b+c);else{this.readUint32BE(a,b+c-4);var e=a.slice(b,b+c);decoder.decode(e);this.m_pol=decoder.m_out}b+=c;c=this.readUint32BE(a,b);b+=4;console.log("CMD size="+c);c&-2147483648?this.m_cmd=a.slice(b,b+(4294967296-c)):(this.readUint32BE(a,b+c-4),a=a.slice(b,b+c),decoder.decode(a),this.m_cmd=decoder.m_out)}};
